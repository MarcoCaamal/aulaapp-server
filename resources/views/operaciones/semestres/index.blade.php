        ...
        <div class="col-12 mb-3">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h1 class="h4">Semestres</h1>
                    <a href="{{ route('semestres.create') }}" class="btn btn-primary btn-lg me-3 text-white">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('semestres.edit', ['id' => $semestre->id]) }}">
                                                    ...
                                                    <li>
                                                        <form class="formEliminar" method="POST">
                                                            <input type="hidden" class="urlAPI"
                                                                value="/semestres/delete/{{ $semestre->id }}">
