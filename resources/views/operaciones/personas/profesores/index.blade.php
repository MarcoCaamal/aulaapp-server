        ...
        <div class="col-12 mb-3">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h1 class="h4">Profesores</h1>
                    <div>
                        {{-- <a href="{{ route('profesores.carga-masiva') }}" class="btn btn-success btn-lg me-3 text-white">
                            <i class='bx bx-plus-circle'></i> <span class="d-none d-md-inline-block">Carga Masiva</span>
                        </a> --}}
                        <a href="{{ route('profesores.create') }}" class="btn btn-primary btn-lg me-3 text-white">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('profesores.edit', ['id' => $profesor->id]) }}">
                                                    ...
                                                    <li>
                                                        <form class="formEliminar" method="POST">
                                                            <input type="hidden" class="urlAPI"
                                                                value="/profesores/delete/{{ $profesor->id }}">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('horarios.index', ['idProfesor' => $profesor->id]) }}">
                                                            <i class='bx bxs-calendar me-2'></i>Horarios
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
