        ...
        <div class="col-12 mb-3">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h1 class="h4">Horarios De {{ $profesor->getFullName() }}</h1>
                    <div>
                        <a href="{{ route('profesores.index') }}" class="btn btn-outline-secondary btn-lg">
                            <i class='bx bx-arrow-back'></i> <span class="d-none d-md-inline-block">Regresar</span>
                        </a>
                        <a href="{{ route('horarios.create', ['idProfesor' => $profesor->id ]) }}" class="btn btn-primary btn-lg me-3 text-white">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('horarios.edit', ['idProfesor' => $profesor->id, 'idHorario' => $horario->id]) }}">
                                                            <i class='bx bx-edit-alt me-2'></i>Editar
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <form class="formEliminar" method="POST">
                                                            <input type="hidden" class="urlAPI" value="/profesores/{{ $profesor->id }}/horarios/delete/{{ $horario->id }}">
